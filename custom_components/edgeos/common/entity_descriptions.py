...
ENTITY_DESCRIPTIONS: list[IntegrationEntityDescription] = [
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_TOTAL,
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_ENABLED,
        native_unit_of_measurement=UnitOfEdgeOS.QUEUES,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_UPLOAD_LIMIT,
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_DOWNLOAD_LIMIT,
        device_class=SensorDeviceClass.DATA_RATE,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:download-network-outline",
        device_type=DeviceTypes.SYSTEM,
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_TX_RATE,
        device_class=SensorDeviceClass.DATA_RATE,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:upload-network-outline",
        device_type=DeviceTypes.SYSTEM,
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_TX_TRAFFIC,
        device_class=SensorDeviceClass.DATA_SIZE,
        state_class=SensorStateClass.TOTAL_INCREASING,
        icon="mdi:upload-network-outline",
        device_type=DeviceTypes.SYSTEM,
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_RX_DROPPED,
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_TX_DROPPED,
        native_unit_of_measurement=UnitOfEdgeOS.DROPPED,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:package-variant-minus",
        device_type=DeviceTypes.SYSTEM,
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_RX_ERRORS,
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_TX_ERRORS,
        native_unit_of_measurement=UnitOfEdgeOS.ERRORS,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:timeline-alert",
        device_type=DeviceTypes.SYSTEM,
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_RX_PACKETS,
    ...
    IntegrationSensorEntityDescription(
        key=EntityKeys.SMART_QUEUE_TX_PACKETS,
        native_unit_of_measurement=UnitOfEdgeOS.PACKETS,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:package-up",
        device_type=DeviceTypes.SYSTEM,
